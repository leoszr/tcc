# H02.1 — Criar model `Reserva` (fields e constraints)
...
- As definições batem com a migration criada em H01.3.

Dependências:

- H01.3 (migration) ou, se a migration for criada após, alinhar os nomes/nomem de colunas.
